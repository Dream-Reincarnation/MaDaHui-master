package com.ajiani.maidahui.weight.circle;
...
public class CircularProgressView extends View {
    ...
    private float startAngle=275;



    int maxProgress=15000;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mRectF, startAngle,360 * mProgress / maxProgress, false, mProgPaint);
    }
