package com.ajiani.maidahui.tencent;
...
import com.ajiani.maidahui.tencent.activity.TCBaseActivity;
...
//                mCurrentPosition = position;
    ...
    class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Glide.with(TCVodPlayerActivity.this).load(tcLiveInfo.frontcover).into(coverImageView);
            // 头像
            ...
            if(tcLiveInfo.review_status == TCVideoInfo.REVIEW_STATUS_NOT_REVIEW){
                ...
                tvVideoReviewStatus.setText("视频未审核");
            }else if(tcLiveInfo.review_status == TCVideoInfo.REVIEW_STATUS_PORN){
                tvVideoReviewStatus.setVisibility(View.VISIBLE);
                tvVideoReviewStatus.setText("视频涉黄");
