...
import com.ajiani.maidahui.adapter.record.TCVideoEditerAdapter;
...
public class TCVideoEditView extends RelativeLayout implements RangeSlider.OnRangeChangeListener {
    ...
    private static long mVideoStartPos; // 最终视频的起始时间
    private static long mVideoEndPos; // 最终视频的结束时间
    ...
    public void setMediaFileInfo(TXVideoEditConstants.TXVideoInfo videoInfo) {
        ...
        if (mVideoDuration >= 60000){
            mViewMaxDuration = 60000;
        } else {
    ...
    public static int getSegmentFrom() {
        return (int) mVideoStartPos;
    }

    public static int getSegmentTo() {
