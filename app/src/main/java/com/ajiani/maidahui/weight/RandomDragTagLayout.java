...
public class RandomDragTagLayout extends FrameLayout {
     ...
     */
    public boolean addTagView(String text,String a, final float x, final float y, boolean isShowLeftView) {
        if (text == null || text.equals("")) return false;
       // RandomDragTagView tagView = new RandomDragTagView(getContext(),a);
