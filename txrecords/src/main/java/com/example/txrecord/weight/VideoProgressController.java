...
import com.example.txrecord.weight.times.ColorfulProgress;
import com.example.txrecord.weight.times.RangeSliderViewContainer;
import com.example.txrecord.weight.times.SliderViewContainer;
import com.example.txrecord.weight.times.VideoProgressView;
...
public class VideoProgressController {
    ...
    public int calculateStartViewPosition(@NonNull RangeSliderViewContainer rangeSliderView) {
   ...
   public  int calculateSliderViewPosition(@NonNull SliderViewContainer sliderViewContainer) {
    ...
    public int calculateColorfulProgressOffset() {
