...
import com.example.txrecord.UIAttributeUtil;
import com.example.txrecord.baseic.IPlayControlLayout;
...
public class PlayControlLayout extends RelativeLayout implements IPlayControlLayout, View.OnClickListener, PlayerManagerKit.OnPreviewListener, PlayerManagerKit.OnPlayStateListener {
    ...
    private void initViews() {
        ...
        mPlayIcon = UIAttributeUtil.getResResources(getContext(), R.attr.editerPlayIcon, R.mipmap.music_pause);
        mPauseIcon = UIAttributeUtil.getResResources(getContext(), R.attr.editerPauseIcon, R.mipmap.music_start);
    }
