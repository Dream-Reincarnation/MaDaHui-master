...
public class IntengralUserFragment extends  BaseFragment<IntegralIn.IntegralView, IntegralPresenter> implements IntegralIn.IntegralView{
    @BindView(R.id.rel)
    RecyclerView rel;
    @BindView(R.id.smart)
