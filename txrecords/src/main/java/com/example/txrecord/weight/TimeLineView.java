 ...
 * 编辑控件：图片时间轴
 */
public class TimeLineView extends RelativeLayout implements ITimeLineView, VideoProgressController.VideoProgressSeekListener {
    ...
    private long time=0;
    private TimeLineView.onClickLinstener onClickLinstener;
