...
//    public static final int BEAUTYPARAM_BEAUTY_STYLE = 9;
    ...
    private String[] mMotionTypeString = {
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_none),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_boom),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_neon_mouse),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_star_ear),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_crazy_cheer_up),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_Q_cancelonstellation),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_colored_ribbon),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_bands_hairband),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_change_face),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_purple_kitten),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_flower_faerie),
            getResources().getString(R.string.beauty_setting_pannel_dynamic_effect_little_Princess),
    };
    private String[] mGreenString = {
            getResources().getString(R.string.beauty_setting_pannel_green_screen_none),
            getResources().getString(R.string.beauty_setting_pannel_green_screen_good_luck),
    };
    private String[] mKoubeiString = {
            getResources().getString(R.string.beauty_setting_pannel_key_none),
            getResources().getString(R.string.beauty_setting_pannel_key_AI_key),
    };
...
//    };
    ...
    private SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(MyApp.getApp());
