package com.ajiani.maidahui.weight.chat;
...
public class RecordButton extends AppCompatButton {
    ...
    private String mFile =  getContext().getFilesDir()+ "/"+"voice"+ System.currentTimeMillis()+".aac";
     ...
     * 最长录音时间
     **/
    private int MAX_INTERVAL_TIME = 1000 * 59;
